...
// output: Guided first-writing exercise, copyable prompts, recovery instructions and heading navigation
  ...
  return (
    <div className="docs-layout">
      <section className="docs-hero">
        ...
        <h1>跟着做，写出你的第一段故事</h1>
        <p>
          从安装到继续写作，用同一个小练习走完五步。打开 Storyflow 桌面应用，把教程放在旁边，边看边做。
        </p>
      </section>
      <nav className="docs-toc" aria-label="教程目录">
        ...
        <a href="#review-changes">4. 修改与审阅</a>
        <a href="#save-return">5. 保存与继续</a>
        <p className="docs-nav-group">遇到问题</p>
        <a href="#troubleshooting">按现象排查</a>
        <a href="#checklist">检查是否学会</a>
      ...
      <article className="docs-page" ref={article}>
        <section className="docs-summary">
          ...
          <a className="docs-next" href="#install">从安装开始 →</a>
          <a className="docs-next" href="#create-project">已经能正常对话？从项目开始 →</a>
        </section>
        ...
        <section className="docs-section" id="install">
          <div className="docs-section-copy">
            ...
            <p className="docs-checkpoint"><strong>完成标志</strong>收到一条正常回复，而不是“不可用”、登录提醒或连接错误。遇到问题先看<a href="#help-model">模型无法使用</a>。</p>
            ...
            <a className="docs-next" href="#create-project">模型能回复了，创建练习项目 →</a>
          </div>
        </section>
        ...
        <section className="docs-section" id="create-project">
          <div className="docs-section-copy">
            ...
            <a className="docs-next" href="#first-task">项目准备好了，写第一段正文 →</a>
          </div>
        </section>
        ...
        <section className="docs-section" id="first-task">
          <div className="docs-section-copy">
            ...
            <p className="docs-checkpoint"><strong>完成标志</strong>能打开两份文件：创作要求和第一章正文。找不到文件时，按<a href="#help-file">文件没有出现</a>处理。</p>
          </div>
          ...
          <a className="docs-next" href="#review-changes">正文能打开了，练习一次修改 →</a>
        </section>
        ...
        <section className="docs-section" id="review-changes">
          ...
          <a className="docs-next" href="#save-return">改动确认好了，保存版本 →</a>
        </section>
        ...
        <section className="docs-section" id="save-return">
          ...
          <a className="docs-next" href="#checklist">检查是否已经学会 →</a>
        </section>
        ...
        <section className="docs-section docs-checklist" id="checklist">
          <div className="docs-section-copy">
            ...
            <ul className="docs-inline-list">
              <li><a href="#create-project">找到练习项目</a>，说出文件保存在电脑的哪个文件夹。</li>
              <li><a href="#write-opening">打开第一章</a>，区分聊天里的回答和已经保存的稿件。</li>
              <li><a href="#review-changes">引用一个文件</a>，让助手只改指定的一句话，再核对结果。</li>
              <li><a href="#save-return">保存并重新打开</a>，确认修改没有丢失。</li>
            </ul>
        ...
        <section className="docs-section" id="troubleshooting">
          <div className="docs-section-copy">
            ...
            <p>先看输入框下方是否选中了模型。使用托管模型时，到“个人资料”确认已登录；提示登录失效时重新登录。使用自己的连接时，到“设置 → AI”核对连接配置。若仍有错误，保留错误文字再<a href="#tutorial-contact">联系我们</a>，不要把不停点发送当作修复。</p>
        ...
        <div className="docs-reference-heading">
          ...
          <h2 id="reference-title">第一次练习做完，再按需查这里</h2>
          <p>下面补充文件整理、协作和技能的用法。页面中的实拍来自示例项目，标注属于教程，不是应用里的按钮。</p>
        </div>
