  ...
  return (
    <div className="docs-layout">
      <section className="docs-hero">
        ...
        <h1>从一个项目，写出第一份稿件</h1>
        <p>
          从安装到审阅第一份稿件，跟着四步开始。已有项目，也可以用目录直接查找需要的操作。
        </p>
      </section>
      ...
      <article className="docs-page">
        ...
        <section className="docs-section" id="install">
          <div className="docs-section-copy">
            ...
            <p>
              打开应用后按引导完成设置。使用 Storyflow
              托管模型需要登录账号；使用自己的模型服务时，在设置中配置相应连接，并在对话中选择可用模型。
            </p>
            <p className="docs-note">
              作品文件保存在本地文件夹中。使用在线模型时，请求及任务所需内容会发送给相应服务商。
            </p>
          </div>
        </section>
        ...
        <section className="docs-section" id="create-project">
          <div className="docs-section-copy">
            ...
            <ul className="docs-inline-list">
              ...
              <li>
                导入已有内容：选择 Markdown 或 TXT
                文件；同名文件会跳过，不会覆盖。
              </li>
              <li>新建文件：从一个真实文件开始，按需要逐步形成目录。</li>
              <li>
                使用 Skill：为当前任务选择可复用的写作方法，也可以稍后再添加。
              </li>
            </ul>
            <details className="docs-more">
              <summary>想继续规划整本作品？</summary>
              <p>
                没有旧稿时，建议先描述项目；已有材料时，直接导入文件。随后按真实工作需要逐步沉淀：
              </p>
              <ul className="docs-inline-list">
              ...
              <p>
                如果作者只是想临时问一个问题，可以继续用聊天；如果要认真推进一篇作品，就应该创建项目。
              </p>
        ...
        <section className="docs-section" id="first-task">
          <div className="docs-section-copy">
            ...
            <blockquote className="prompt-example">
              我想写一个悬疑短篇：主角是一名修复旧照片的店主，在一张合照中发现了不该出现的人。先帮我讨论主角动机和核心冲突，列出需要我决定的问题，暂时不要修改文件。
            </blockquote>
            <p>
              如果只想分析，可使用探索模式。确认方向后，切换到允许写入的模式，再明确要求把结果保存到项目里。
            </p>
            <blockquote className="prompt-example">
              根据刚才确认的方向，在项目中新建<code>故事简报.md</code>
              ，写下主角、核心冲突、预期篇幅和待定问题。先只完成简报，不写正文。
            </blockquote>
            <p className="docs-note">
              完成信号：项目目录出现<code>故事简报.md</code>
              ，打开后能看到内容。若结果只在聊天里，继续要求助手保存到文件；已有稿件则可以用
              @ 引用对应文件，再说明具体修改范围。
            </p>
          </div>
        </section>
        ...
        <section className="docs-section" id="review-changes">
          <div className="docs-section-copy">
            ...
            <p>
              ...
              Accept（接受）；不想保留的改动选择
              Reject（拒绝），或在对话中说明需要调整的地方。
            </p>
            <p className="docs-note">
              审阅的是已经写入文件的改动。接受表示保留，拒绝会尝试撤回；如果文件出现冲突，先核对内容，再继续处理。
            </p>
            <p>
              打开“版本管理”，点击“保存当前版本”旁的“保存”，确认历史列表中出现新记录。继续写作时先完成一个章节，再检查人物、设定和情节；需要恢复时，先核对版本记录的时间和说明。
            </p>
          </div>
        ...
        <section className="docs-section" id="header-tools">
          ...
          <div className="docs-tour">
            <ProductTour
              steps={["workspace", "sources", "skills"]}
              label="常用入口实拍"
              detail
            />
          </div>
          <ul className="docs-bullet-list">
            ...
            <li>
              <strong>数据源：</strong>
              接入资料、文件夹、外部服务，适合挂参考资料和素材库。
            </li>
            <li>
              <strong>技能：</strong>
              给助手加载专门工作方法，例如写作法、拆文法、审校法。
            </li>
            <li>
              <strong>自动化：</strong>
              让任务按规则自动运行，适合定时检查和持续跟进。
            </li>
            <li>
        ...
        <section className="docs-section" id="window-map">
          ...
          <ul className="docs-bullet-list">
            <li>
              <strong>资料目录：</strong>
              一本书的分区书架。正文、大纲、角色、风格、素材分开放，避免所有信息混在聊天记录里。
            </li>
            <li>
              <strong>正文 / 文档区：</strong>
              正在编辑的作品文件。截图里打开的是第一章正文，它会被保存成作品资产。
            </li>
            <li>
              <strong>助手协作区：</strong>
              左侧对话呈现目标、结果和文件引用；点击文件链接在右侧打开正文。
            </li>
            <li>
              <strong>输入区：</strong>
              作者给助手下一步任务，例如继续、重写、加强冲突、改成更爽。
            </li>
          </ul>
        </section>
        ...
        <section className="docs-section" id="source-tree">
          ...
          <div className="docs-tour">
            <ProductTour steps={["context"]} label="项目目录实拍" detail />
          </div>
          <ul className="docs-bullet-list">
            <li>
              <strong>全局信息：</strong>
              放大纲、人物、地点、风格、时间线、状态、素材等长期资料。
            </li>
            <li>
        ...
        <section className="docs-section" id="collaboration">
          ...
          <ul className="docs-bullet-list">
            ...
            <li>
              <strong>助手反馈：</strong>
              检查章节钩子、主要事件、信息差、情绪落点等 beat 是否对齐。
            </li>
            <li>
              <strong>下一步：</strong>
              作者像和编辑沟通一样，要求继续写、重写、调整节奏或加强某条线。
            </li>
          </ul>
        </section>
        ...
        <section className="docs-section" id="initial-brief">
          ...
          <div className="docs-tour">
            <ProductTour steps={["workspace"]} label="创作目标实拍" detail />
          </div>
        </section>
        ...
        <section className="docs-section" id="full-review">
          ...
          <div className="docs-tour">
            <ProductTour steps={["skills"]} label="技能说明实拍" detail />
          </div>
          <div className="docs-section-copy docs-subsection">
            <p>
              点击输入区的加号，移到「选择技能」，搜索并选择已安装的技能；也可以在技能详情中点击「立即使用」。
            </p>
          </div>
          <div className="docs-tour">
            <ProductTour steps={["add-menu"]} label="输入区菜单实拍" detail />
          </div>
        </section>
      </article>
    </div>
