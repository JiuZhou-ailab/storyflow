...
describe('BrowserPaneManager', () => {
  ...
  it('focus brings the instance window to front', () => {
    ...
    instance.toolbarView.webContents.getURL = mock(() => 'file:///renderer/browser-toolbar.html')
  ...
  it('loads toolbar fallback page after retry exhaustion', async () => {
    ...
    expect(instance.toolbarView.webContents.loadURL).toHaveBeenCalledWith(expect.stringContaining('data:text/html'))
  })
