// input: Static chat fixtures and playground control state
// output: Interactive TurnCard and overlay component examples
// pos: Renderer playground registry for transcript presentation QA
