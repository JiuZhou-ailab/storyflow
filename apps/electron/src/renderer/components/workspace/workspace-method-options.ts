...
const WORKSPACE_CREATION_METHOD_OPTIONS_INTERNAL = [
  ...
  },
  {
    ...
    fallbackSubtitle: "面向 5,000-30,000 字中文网文，一个工作区一本书，在简报里锁定黄金三章和密度选择，再靠大纲、人物、素材撑住正文。",
    fallbackPreviewMermaid: "flowchart TD\n  A[初始请求] --> B[简报.md]\n  B --> B1[题材定位]\n  B --> B2[主角设置]\n  B --> B3[核心钩子]\n  B --> B4[黄金三章]\n  B --> B5[密度选择]\n  B4 --> C1[第1章拉新]\n  B4 --> C2[第2章加压]\n  B4 --> C3[第3章锁留存]\n  B5 --> D[大纲.md]\n  C3 --> D\n  D --> D1[分章 beat]\n  D --> E[人物.md]\n  D --> F[素材.md]\n  D1 --> G[正文/NN-标题.md]\n  G --> H[git diff 留痕]\n  G --> I[.work/ 试稿与审校]",
    ...
    richPreview: {
      accent: "neutral",
      thesis: "面向中文短篇/中篇网文的写作搭档，用 简报里的黄金三章和密度选择，加上 大纲 / 人物 / 素材 撑住正文，每章一个 NN-标题.md。",
      stages: [
      ...
      structure: [
        ...
        { label: "当前作品", items: ["简报.md 当前作品的卖点", "简报.md 黄金三章与密度选择", "大纲.md / 人物.md / 素材.md"] },
