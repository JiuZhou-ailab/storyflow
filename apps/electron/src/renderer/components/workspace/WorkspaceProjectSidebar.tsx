// input: Controlled project-tree props plus sidebar focus and empty-state copy
// output: Lazy project file tree with a folder-first cold-start hint
// pos: Project directory surface owned by the Activity Rail sidebar
