...
describe('resolveChatOpeningPrompt', () => {
  ...
  it('uses normalized opening metadata before the resolved runtime workspace metadata', () => {
    expect(chatPageSource).toContain('const chatWorkspace = runtimeWorkspace')
