// input: Storyflow thinking levels and Pi SDK agent types
// output: Thinking-level and tool-name mappings shared by the Pi runtime adapters
// pos: Canonical translation boundary between Storyflow agent contracts and Pi
