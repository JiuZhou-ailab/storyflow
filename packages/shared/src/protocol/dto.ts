...
export type SessionEvent =
  ...
  | { type: 'text_complete'; sessionId: string; text: string; model?: string; isIntermediate?: boolean; turnId?: string; parentToolUseId?: string; timestamp?: number; messageId?: string; canBranch?: boolean }
