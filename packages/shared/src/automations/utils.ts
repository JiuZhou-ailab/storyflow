...
import type { AgentAutomationInput, AutomationEvent, AutomationMatcher, PromptReferences, AgentEvent } from './types.ts';
...
/**
 * Get the match value for agent events.
 * Each event type matches against a specific field from the normalized input.
 */
