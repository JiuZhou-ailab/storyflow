...
Extract evidence-backed writing bible files from source texts into `.work/analysis/output/<source-slug>/`. Preserve quotes, distinguish facts from interpretation, and avoid inventing missing details.
