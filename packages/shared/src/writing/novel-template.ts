...
- \`简报.md\`：当前作品的题材、卖点、目标读者、核心钩子、篇幅目标。
- \`大纲.md\`：分章节 beat 计划，每章一段。
- \`人物.md\`：角色档案、关系、动机、口头禅、成长曲线。
- \`素材.md\`：地点、行业知识、对标桥段、可复用台词。
- \`正文/\`：唯一成稿目录，章节命名 \`NN-标题.md\`。
- \`.work/\`：临时大纲实验、被废弃章节版本、试写、审校笔记。

## 命名规则

- \`正文/NN-标题.md\`，例如 \`正文/01-未婚夫和闺蜜在我葬礼上接吻.md\`。
- \`.work/YYYYMMDD-目的.md\`，例如 \`.work/20260514-反派人设试稿.md\`。
...
| 路径 | 用途 | 谁主笔 |
| --- | --- | --- |
| 创作要求.md | 跨项目长期写作风格、读者偏好、禁区 | 用户主笔，模型补充 |
| 简报.md | 当前作品的题材、卖点、主角、目标读者、核心钩子、篇幅目标 | 用户与模型协作 |
| 大纲.md | 分章节 beat 计划，每章一段 | 用户与模型协作 |
| 人物.md | 主要角色档案、关系、动机、口头禅、成长曲线 | 用户与模型协作 |
| 素材.md | 地点、行业、对标桥段、可复用台词 | 用户与模型协作 |
| 正文/ | 唯一成稿目录，每章一个 \`NN-标题.md\` | 模型主笔，用户审定 |
| .work/ | 临时大纲实验、被废弃的章节版本、试写、审校笔记 | 模型 |

## 命名规则

- 正文：\`正文/NN-标题.md\`，NN 是两位章节编号，标题就是章节钩子。例如 \`正文/01-未婚夫和闺蜜在我葬礼上接吻.md\`。
- 临时工作：\`.work/YYYYMMDD-目的.md\`，例如 \`.work/20260514-反派人设试稿.md\`。
