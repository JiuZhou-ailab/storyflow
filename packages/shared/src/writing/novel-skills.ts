...
const OH_STORY_SKILLS = [
  ...
  adapterSkill({
    slug: "story",
    title: "Story Router",
    description: "Use when the user gives a broad web-fiction writing request and needs routing to the right Oh Story workflow.",
    attribution: OH_STORY_ATTRIBUTION,
    purpose: "Classify broad requests into market scanning, benchmark analysis, drafting, revision, review, or cover ideation.",
    context: ["Long-form work uses long-scan, long-analyze, and long-write.", "Short-form work uses short-scan, short-analyze, and short-write.", "Accepted manuscript lives in 正文/."],
    workflow: ["Inspect the current project files.", "Choose the narrowest matching writing workflow.", "State the selected workflow and continue without duplicating work across skills."],
    output: ["Selected workflow.", "Immediate file targets.", "Any blocking missing context."],
  }),
  adapterSkill({
  ...
  adapterSkill({
    ...
    description: "Use when planning or drafting long-form online fiction chapters.",
    attribution: OH_STORY_ATTRIBUTION,
  ...
  adapterSkill({
    ...
    description: "Use when planning, drafting, or polishing a short web-fiction story.",
    attribution: OH_STORY_ATTRIBUTION,
    purpose: "Create compact, high-payoff short fiction with clear hook, escalation, reversal, and ending.",
    context: ["Use 大纲/ for compressed structure.", "Draft in .work/ before writing accepted text to 正文/.", "Track factual continuity in 追踪/ when the story spans multiple scenes."],
    workflow: ["Confirm premise, emotional target, reversal, and ending.", "Create a beat outline.", "Draft with tight scene economy.", "Revise for hook clarity and payoff integrity."],
