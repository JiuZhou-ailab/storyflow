...
export const CLAUDE_BOOK_METHOD_PACK: MethodPack = {
  ...
  requiredPaths: [
    ...
    { path: ".work/analysis/src", kind: "directory" },
    { path: ".work/analysis/output", kind: "directory" },
  ],
  requiredSkills: [
    "book-analyzer",
    "bible-merger",
  ...
  runtimePreamble: "This project uses the novel.claude-book method pack. Use bible/ as canon, story/chapters/ as manuscript, state/current/ as current continuity state, timeline/ as chronology, and .work/ for drafts, reports, and temporary analysis.",
