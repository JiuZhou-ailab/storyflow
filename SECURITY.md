...
We take security seriously. If you discover a security vulnerability in Storyflow, please report it responsibly.
...
- The Storyflow desktop application
- The `@craft-agent/*` npm packages
- Official Storyflow repositories
