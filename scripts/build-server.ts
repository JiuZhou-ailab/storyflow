...
function showHelp(): void {
  console.log(`
Standalone server build script for Storyflow
...
# Storyflow Server — convenience entry point
...
async function main(): Promise<void> {
  ...
  console.log(`=== Building Storyflow Server ${version} for ${platform}-${arch} ===`);
